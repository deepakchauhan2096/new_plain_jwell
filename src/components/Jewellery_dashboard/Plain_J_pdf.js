        ...
        <Document>
            <Page size="A4" style={styles.page}>
                ...
                <View style={{ display: "flex", justifyContent: "space-between", flexDirection: "row", paddingBottom: "30px" ,borderBottom:"2px solid grey"}}>
                    ...
                    <Text style={{color:"red", alignSelf:"center"}}>Plain Jewellery Invoice</Text>
                    </View>
                ...
                >
                    <TableHeader>
                        ...
                        <TableCell style={styles.productTableHeading} >Metal type</TableCell>
                        <TableCell style={styles.productTableHeading} >Retail price</TableCell>
                        <TableCell style={styles.productTableHeading} >Product id</TableCell>
                        <TableCell style={styles.productTableHeading} >metal_category</TableCell>
                        <TableCell style={styles.productTableHeading} >product_category</TableCell>
                        <TableCell style={styles.productTableHeading} >detail_product_des</TableCell>
                        <TableCell style={styles.productTableHeading} > metal_weight_gm</TableCell>
                        <TableCell style={styles.productTableHeading} >total_price</TableCell>
                        <TableCell style={styles.productTableHeading} >edit_dec</TableCell>
                        <TableCell style={styles.productTableHeading} >unit_price</TableCell>
                    ...
                    <TableBody>
                        ...
                        <DataTableCell style={styles.productTableText} getContent={(r) => r.metal_type} />
                        <DataTableCell style={styles.productTableText} getContent={(r) => r.retail_price} />
                        <DataTableCell style={styles.productTableText} getContent={(r) => r.product_id} />
                        <DataTableCell style={styles.productTableText} getContent={(r) => r.metal_category} />
                        <DataTableCell style={styles.productTableText} getContent={(r) => r.product_category} />
