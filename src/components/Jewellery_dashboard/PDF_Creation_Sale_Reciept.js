        ...
        <Document>
            <Page size="A4" style={styles.page}>
                ...
                <View style={{ display: "flex", justifyContent: "space-between", flexDirection: "row", paddingBottom: "11px", borderBottom: "2px solid grey" }}>
                    <Image source={logo} style={{ width: "50 px", height: "50 px" }}></Image>
                    <View>
                ...
                <Table
                    data={[
                        {
                            payment_name: "Bank",
                            amount: customer_info.Bank_amount,
                            remark: customer_info.Bank_remark,
                        },
                        {
                            payment_name: "Card",
                ...
                <Table data={[
                    ...
                    { data_1: "", data_2: customer_info.totalPriceInWord, data_3:`€ ${customer_info.totalPrice}`}
                    ]}>
                    <TableBody>
